...
public class RepositorioLivrosArray implements RepositorioLivros {
	...
	@Override
	public void inserir1(Livro livro) throws LivroJaCadastradoException {
	...
	@Override
	public Livro procurar1(String codigo) throws LivroNaoEncontradoException {
		// TODO Auto-generated method stub
		return  this.livros[this.getIndice(codigo)];
	}
	
	@Override
	public void atualizar1(Livro livro, Livro livroAtualizado) throws LivroNaoEncontradoException {
		// TODO Auto-generated method stub

...
public class ClasseTeste {
	...
	public static void main(String[] args) throws ProdutoNaoEncontradoException, ProdutoFaltandoNoEstoqueException,
		...
		RepositorioEventos repEventosArray = new RepositorioEventosArray(100);
		RepositorioProdutos repLivrosArray = new RepositorioProdutosArray(100);
		RepositorioProdutos repJogosArray = new RepositorioProdutosArray(100);
		Scanner in = new Scanner(System.in);

		String teste = in.nextLine(); // aqui será usado o arquivo config.txt

		Livro produto = new Livro("Livro Legal", "Autor Incrivel", "Editora4", 50.0, "123", 5);
